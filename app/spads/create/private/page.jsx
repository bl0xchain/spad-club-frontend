...
const CreatePrivateSpad = () => {
    ...
    const handleStartSpad = async (e) => {
        ...
        if(passKey === '') {
            toast.error("Pass key is required for private SPADs");
            return;
        }
        ...
        <Container>
            ...
            <form className='bg-white mx-auto mt-4 rounded-lg border max-w-2xl sm:mt-8 p-8 shadow-xl' onSubmit={handleStartSpad}>
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3 mb-6">
                    ...
                    <div className="sm:col-start-2">
                        <label htmlFor="passKey" className='block mb-2 text-sm font-medium text-gray-900'>
                            PASSKEY
                        </label>
                        <TextInput
                            id="passKey"
...
export default CreatePrivateSpad